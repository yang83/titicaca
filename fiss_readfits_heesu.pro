function fiss_readfits_heesu, filename, wl, h, pca=pca, no_wvcalib=no_wvcalib, rotnshift=rotnshift, MAGNIFY=MAGNIFY, ENLARGE=ENLARGE, FOR_MAPSTRUCTURE=FOR_MAPSTRUCTURE
